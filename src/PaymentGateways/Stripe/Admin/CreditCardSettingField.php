...
class CreditCardSettingField
{
    ...
    private function getRadioButtons($field, $value)
    {
        ...
        <div class="give-stripe-credit-card-options">
            ...
            echo 'payments' === $value ? 'give-stripe-boxshadow-option-wrap__selected' : ''; ?>">
                ...
                <label>
                    <input
                        ...
                        style=""
                        <?php
                        checked('payments', $value); ?>
                    >
                    <span class="stripe-cc-fields-radio-title"><?php
                        esc_html_e('Payments Field', 'give'); ?></span>
                    <span class="stripe-cc-fields-radio-description"><?php
                        esc_html_e(
                            'The Stripe Payments element allows blah blah.',
                            'give'
                        ); ?></span>
                    <span class="stripe-cc-fields-example stripe-cc-fields-example__payments">
